...
export class Pagination {
    ...
    private paginatableItems: Paginatable<ToString>;
    private currentPage: number;
    private previousPagination: Paginatable<ToString> | undefined;

    constructor(
        paginationId: string,
        listId: string,
        paginatableItems: Paginatable<ToString>,
    ...
    getTotalPages(): number {
        return Math.ceil(
            this.paginatableItems.getTotalCount() / this.itemsPerPage
        );
    }
